...
Lava::Report("#################################################################################");
Lava::Report("#      Title           : BRENTBUFFHAM_FileToSurpac                              #");
...
Lava::Report("#      Version 01 Date : 26 JAN 2023                                            #");
Lava::Report("#################################################################################");
	...
	if($panel->execute("$panelTitle1")){
		...
		for(my $polygon = new Lava::Selection("Select the Object to STR","multi,shadow"); $polygon->has_more; $polygon->next)
		{
			...
			if($polygon->is_poly){
				...
				$panel->text(" ");
				$panel->text("Karara Common Codes:");
				$panel->text("Blast:511, Ramp:1, CrestLine:2 ToeLine:3");
				$panel->text("WS:911, PAF:912, MGB:931, MGO:942, MGG:943, MGP:944, MGY:945");
