...
export function updatePopup() {
    ...
    window.Swal.fire({
        ...
        html: '<svg version="1.1" baseProfile="basic" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="70" height="70" viewBox="-40 0 200 200" stroke-width="3" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">' +
            ...
            '<label class="labelWhite12c">⭐ ⭐ September 2025 - January 2026 ⭐ ⭐</label>' +
            '<br>' +
            '<label class="labelWhite12c">' +
            '📱 <b>User Interface</b><br>' +
            '✅ HUD Overlay System – Unified display for status, selections, and coordinates (2D/3D)<br>' +
            '✅ 3D Measurement Panels – Ruler, Protractor, and Measurement Panels<br>' +
            '✅ Surface Legend – Compact, multi-surface layout with hillshade colors<br>' +
            '✅ Modernized dialogs to FloatingDialog <br>' +
            '(surface assign, proximity warnings, holes along line/polyline, confirmations with input fields)<br>' +
            '✅ Context Menus – Delete/renumber confirmation, 3D menu support<br>' +
            '✅ TreeView – Rename surfaces/images, fix delete, improved color swatches<br>' +
            '✅ Floating Toolbar – Hole add tool & KAD controls. Compressed font styling<br>' +
            '✅ Sidebar-Toolbar Sync – Elevation/line width/radius sync live<br>' +
            '✅ Billboard Controls – Off, Holes, KAD, All'
            + '</label><br>'
            + '<label class="labelWhite12c">'
            + '🛠️ <b>Features and Tools</b><br>' +
            '✅ Instanced rendering (hole collars, grades, polylines, circles)<br>' +
            '✅ 3D KAD vertex manipulation – XYZ, raycast + snap elevation<br>' +
            '✅ 3D Cursor/Snapping – Cylindrical “fat ray”, depth-priority<br>' +
            '✅ Troika Text – Improved SDF rendering (128px glyphs)<br>' +
            '✅ Ruler Tool – 3D distance measurement<br>' +
            '✅ Protractor Tool – Angle + draw features<br>' +
            '✅ Drawing Distance Panel – Live display while drawing<br>' +
            '✅ IREDES Export – XML with CRC32, hole type handling<br>' +
            '✅ CSV Import – Handles zero/negative subdrill values<br>' +
            '✅ OBJ/MTL/JPG – IndexedDB texture/material support<br>' +
            '✅ Pattern Generation – Holes Along Line/Polyline (dialog modules),<br> ' +
            'Proximity Warning (with cancellation detection)'
            + '</label><br>'
            + '<label class="labelWhite12c">'
            + '🐛 <b>Bugs and Fixes</b><br>' +
            '✅ Production build – Exposed Swal, buildVersion, dialog functions<br>' +
            '✅ IndexedDB persistence – debouncedSaveHoles (property & connector tools)<br>' +
            '✅ TreeView delete recursion – Fixed infinite loop<br>' +
            '✅ Unicode separator (“⣿”) and log icon fixes<br>' +
            '✅ 3D Mode: Print XYZ Gizmo orientation, contours/arrows Three.js updates, <br>' +
            'camera resize/jitter, 2D/3D label match-up<br>'
            + '</label><br>' +
            '<label class="labelWhite12c">' +
            '✅ Geometry & Calculation – Hole assignment slides along vector, <br>' +
            'triangulation naming, direction arrows fixes<br>' +
            '✅ Tool State – KAD right-click escape, Move Tool 3D highlight/drag, <br>' +
            'async entity deletion/cleanup<br>'
            + '</label><br>' +
            '<label class="labelWhite12c">'
            + '⚡ <b>User Experience & Performance</b><br>' +
            '✅ Performance: Memory leak prevention, strict 2D/3D geometry cleanup, <br>' +
            'debounced tree/save/redraw<br>' +
            '✅ UX: Input styling for dark mode (color-scheme: light), selection state sync, <br>' +
            'lead lines toggle by mode<br>'
            + '</label><br>' +
            '<label class="labelWhite12c">'
            + '🎨 <b>Redesigned & Code Architecture</b><br>' +
            '✅ Print system overhaul – Vector PDF Cohen-Sutherland clipping, <br>' +
            'raster PDF via canvas<br>' +
            '(vector PDF clipping, raster PDF via canvas)<br>' +
            '✅ ToolManager class, Dialog extraction to <br>' +
            'KADDialogs.js/ExportDialogs.js/HolePropertyDialogs.js/PatternGenerationDialogs.js<br>' +
            + '</label><br>' +
            '✅ Modularization of TreeView/context/drawing'
            + '</label><br>'
