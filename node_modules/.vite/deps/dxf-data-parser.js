...
// node_modules/dxf-data-parser/dist/DxfArrayScanner.js
...
// node_modules/dxf-data-parser/dist/AutoCadColorIndex.js
...
// node_modules/dxf-data-parser/dist/DxfParser.js
var import_lodash = __toESM(require_lodash());

// node_modules/dxf-data-parser/dist/ParseHelpers.js
...
// node_modules/dxf-data-parser/dist/entities/3dface.js
...
// node_modules/dxf-data-parser/dist/entities/arc.js
var Arc = class {
  ForEntityName = "ARC";
  parseEntity(scanner, curr) {
...
// node_modules/dxf-data-parser/dist/entities/attdef.js
var Attdef = class {
...
// node_modules/dxf-data-parser/dist/entities/circle.js
var Circle = class {
...
// node_modules/dxf-data-parser/dist/entities/dimension.js
var Dimension = class {
...
// node_modules/dxf-data-parser/dist/entities/ellipse.js
var Ellipse = class {
...
// node_modules/dxf-data-parser/dist/entities/insert.js
var Insert = class {
...
// node_modules/dxf-data-parser/dist/entities/line.js
var Line = class {
  ForEntityName = "LINE";
  parseEntity(scanner, curr) {
    const entity = { type: curr.value, vertices: [] };
...
// node_modules/dxf-data-parser/dist/entities/lwpolyline.js
...
// node_modules/dxf-data-parser/dist/entities/mtext.js
var Mtext = class {
  ForEntityName = "MTEXT";
  parseEntity(scanner, curr) {
    const entity = { type: curr.value };
...
// node_modules/dxf-data-parser/dist/entities/point.js
var Point = class {
  ForEntityName = "POINT";
  parseEntity(scanner, curr) {
...
// node_modules/dxf-data-parser/dist/entities/vertex.js
var Vertex = class {
...
// node_modules/dxf-data-parser/dist/entities/polyline.js
var Polyline = class {
...
// node_modules/dxf-data-parser/dist/entities/solid.js
var Solid = class {
  ForEntityName = "SOLID";
  parseEntity(scanner, curr) {
...
// node_modules/dxf-data-parser/dist/entities/spline.js
var Spline = class {
...
// node_modules/dxf-data-parser/dist/entities/text.js
var Text = class {
  ForEntityName = "TEXT";
  parseEntity(scanner, curr) {
    const entity = { type: curr.value };
...
// node_modules/dxf-data-parser/dist/entities/multileader.js
var Multileader = class {
...
var DxfParser = class {
  ...
  getDXFDiff(source, source2, entitiesIds) {
    ...
    let sortedJSON = (0, import_lodash.sortBy)(sourceJSON.entities.filter((item) => item.name), ["handle", "name"]);
    let sorted2JSON = (0, import_lodash.sortBy)(source2JSON.entities.filter((item) => item.name), ["handle", "name"]);
    let dimensionJSON = (0, import_lodash.sortBy)(sourceJSON.entities.filter((item) => item.type == "DIMENSION"), ["handle"]);
    let dimension2JSON = (0, import_lodash.sortBy)(source2JSON.entities.filter((item) => item.type == "DIMENSION"), ["handle"]);
    ...
    (0, import_lodash.forEach)(dimension2JSON, (dimentionNew) => {
      if ((0, import_lodash.findIndex)(dimensionJSON, { handle: dimentionNew.handle }) == -1) {
        newDimension.push(dimentionNew);
      }
    });
    (0, import_lodash.forEach)(dimensionJSON, (dimentionOriginal) => {
      let index = (0, import_lodash.findIndex)(dimension2JSON, (item) => item.handle == dimentionOriginal.handle);
      if (index >= 0) {
        if (!(0, import_lodash.isEqual)(dimentionOriginal.linearOrAngularPoint1, dimension2JSON[index].linearOrAngularPoint1)) {
          let oldPosition = {
            x: (0, import_lodash.ceil)(dimentionOriginal.linearOrAngularPoint1.x, 10),
            y: (0, import_lodash.ceil)(dimentionOriginal.linearOrAngularPoint1.y, 10)
          };
          let newPosition = {
            x: (0, import_lodash.ceil)(dimension2JSON[index].linearOrAngularPoint1.x, 10),
            y: (0, import_lodash.ceil)(dimension2JSON[index].linearOrAngularPoint1.y, 10)
          };
          if (!(0, import_lodash.isEqual)(oldPosition, newPosition)) {
            changePoint1Dimension.push({ ...dimentionOriginal, newPoint1: dimension2JSON[index].linearOrAngularPoint1 });
          }
        }
        if (!(0, import_lodash.isEqual)(dimentionOriginal.linearOrAngularPoint2, dimension2JSON[index].linearOrAngularPoint2)) {
          let oldPosition = {
            x: (0, import_lodash.ceil)(dimentionOriginal.linearOrAngularPoint2.x, 10),
            y: (0, import_lodash.ceil)(dimentionOriginal.linearOrAngularPoint2.y, 10)
          };
          let newPosition = {
            x: (0, import_lodash.ceil)(dimension2JSON[index].linearOrAngularPoint2.x, 10),
            y: (0, import_lodash.ceil)(dimension2JSON[index].linearOrAngularPoint2.y, 10)
          };
          if (!(0, import_lodash.isEqual)(oldPosition, newPosition)) {
            changePoint2Dimension.push({ ...dimentionOriginal, newPoint2: dimension2JSON[index].linearOrAngularPoint2 });
          }
        }
        if (!(0, import_lodash.isEqual)(dimentionOriginal.actualMeasurement, dimension2JSON[index].actualMeasurement)) {
          let oldMeasuremnt = (0, import_lodash.ceil)(dimentionOriginal.actualMeasurement, 10);
          let newMeasuremnt = (0, import_lodash.ceil)(dimension2JSON[index].actualMeasurement, 10);
          if (!(0, import_lodash.isEqual)(oldMeasuremnt, newMeasuremnt)) {
    ...
    (0, import_lodash.forEach)(sortedJSON, (entityOriginal) => {
      let index = (0, import_lodash.findIndex)(sorted2JSON, { handle: entityOriginal.handle });
      if (index >= 0) {
        if (!(0, import_lodash.isEqual)(entityOriginal.position, sorted2JSON[index].position)) {
          let oldPosition = {
            x: (0, import_lodash.ceil)(entityOriginal.position.x, 10),
            y: (0, import_lodash.ceil)(entityOriginal.position.y, 10)
          };
          let newPosition = {
            x: (0, import_lodash.ceil)(sorted2JSON[index].position.x, 10),
            y: (0, import_lodash.ceil)(sorted2JSON[index].position.y, 10)
          };
          if (!(0, import_lodash.isEqual)(oldPosition, newPosition)) {
    ...
    (0, import_lodash.forEach)(sorted2JSON, (entityNew) => {
      if ((0, import_lodash.findIndex)(sortedJSON, { handle: entityNew.handle }) == -1) {
  ...
  _parse(dxfString) {
      ...
      while (!scanner.isEOF()) {
        if (curr.code === 0 && curr.value === "SECTION") {
          ...
          if (curr.value === "HEADER") {
            ...
            const parseBlock2 = parseBlocks();
            dxf.blocks = parseBlock2.blocks;
            dxf.fullblocks = parseBlock2.fullblocks;
            import_loglevel.default.debug("<");
    ...
    function parseLayerStates() {
                ...
                if (item.currentLayer && item.currentLayer !== "0") {
                  switch (curr.code) {
                    case 62:
                      ...
                      let color = getAcadColor2(colorIndex);
      ...
      return { layersStates, layersStatesValue };
    }
  ...
  getComaprison(array1, array2) {
    ...
    const added = [];
    const modified = [];
    (0, import_lodash.forEach)(array2, (item) => {
      if ((0, import_lodash.findIndex)(array1, { handle: item.handle }) == -1) {
        added.push(item);
      }
    });
    (0, import_lodash.forEach)(array1, (entityOriginal) => {
      let index = (0, import_lodash.findIndex)(array2, { handle: entityOriginal.handle });
      if (index >= 0) {
        if (array2[index].type !== "DIMENSION") {
          if (!(0, import_lodash.isEqual)(entityOriginal.position, array2[index].position)) {
            let oldPosition = {
              x: (0, import_lodash.ceil)(entityOriginal.position.x, 10),
              y: (0, import_lodash.ceil)(entityOriginal.position.y, 10)
            };
            let newPosition = {
              x: (0, import_lodash.ceil)(array2[index].position.x, 10),
              y: (0, import_lodash.ceil)(array2[index].position.y, 10)
            };
            if (!(0, import_lodash.isEqual)(oldPosition, newPosition)) {
          ...
          if (!(0, import_lodash.isEqual)(entityOriginal.linearOrAngularPoint1, array2[index].linearOrAngularPoint1)) {
            let oldPosition = {
              x: (0, import_lodash.ceil)(entityOriginal.linearOrAngularPoint1.x, 10),
              y: (0, import_lodash.ceil)(entityOriginal.linearOrAngularPoint1.y, 10)
            };
            let newPosition = {
              x: (0, import_lodash.ceil)(array2[index].linearOrAngularPoint1.x, 10),
              y: (0, import_lodash.ceil)(array2[index].linearOrAngularPoint1.y, 10)
            };
            if (!(0, import_lodash.isEqual)(oldPosition, newPosition)) {
              modified.push({ ...entityOriginal, newPoint1: array2[index].linearOrAngularPoint1, type: "change_position" });
            }
          }
          if (!(0, import_lodash.isEqual)(entityOriginal.linearOrAngularPoint2, array2[index].linearOrAngularPoint2)) {
            let oldPosition = {
              x: (0, import_lodash.ceil)(entityOriginal.linearOrAngularPoint2.x, 10),
              y: (0, import_lodash.ceil)(entityOriginal.linearOrAngularPoint2.y, 10)
            };
            let newPosition = {
              x: (0, import_lodash.ceil)(array2[index].linearOrAngularPoint2.x, 10),
              y: (0, import_lodash.ceil)(array2[index].linearOrAngularPoint2.y, 10)
            };
            if (!(0, import_lodash.isEqual)(oldPosition, newPosition)) {
              modified.push({ ...entityOriginal, newPoint2: array2[index].linearOrAngularPoint2, type: "change_position" });
            }
          }
          if (!(0, import_lodash.isEqual)(entityOriginal.actualMeasurement, array2[index].actualMeasurement)) {
            let oldMeasuremnt = (0, import_lodash.ceil)(entityOriginal.actualMeasurement, 10);
            let newMeasuremnt = (0, import_lodash.ceil)(array2[index].actualMeasurement, 10);
            if (!(0, import_lodash.isEqual)(oldMeasuremnt, newMeasuremnt)) {
  ...
  cleanDxf(source) {
    if (typeof source === "string") {
      ...
      const blocks = [];
      (0, import_lodash.forEach)(dxfData.fullblocks, (item) => {
        if (item.type >= 3) {
          if (item.name[0] === "*") {
      ...
      for (var i = 0; i < dxfLinesArray.length; i++) {
        ...
        let indexVal = (0, import_lodash.findIndex)(blocks, (item) => item == dxfLinesArray[i]);
        if (indexVal >= 0) {
          entity = lineVal;
          console.log(lineVal);
        ...
        if (i > 2) {
          ...
          if (prevVal.trim() === "70" && entityVal === entity && block == "AcDbBlockBegin") {
            ...
            lineVal = (0, import_lodash.replace)(lineVal, "3", "2");
          }
        }
...
// node_modules/dxf-data-parser/dist/index.js
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=dxf-data-parser.js.map
