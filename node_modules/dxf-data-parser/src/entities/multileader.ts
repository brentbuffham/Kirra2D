...
export interface IMultileaderEntity extends IEntity {
	name: string;
	xScale: number;
	yScale: number;
	zScale: number;
...
export default class Multileader implements IGeometry {
	public ForEntityName = 'MULTILEADER' as const;
	public parseEntity(scanner: DxfArrayScanner, curr: IGroup) {
		const entity = { type: curr.value } as IMultileaderEntity;
		curr = scanner.next();
		while (!scanner.isEOF()) {
